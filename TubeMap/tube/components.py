...
class Station:
    def __init__(self, id, name, zones):
        ...
        assert isinstance(self.id, str), "Station ID must be a string"
        assert isinstance(self.name, str), "Station name must be a string"
        assert isinstance(self.zones, set), "Zones must be a set"
...
class Line:
    def __init__(self, id, name):
        ...
        assert isinstance(self.id, str), "Line ID must be a string"
        assert isinstance(self.name, str), "Line name must be a string"
...
class Connection:
    def __init__(self, stations, line, time):
        ...
        assert isinstance(self.stations, set), "Stations must be a set"
        assert isinstance(self.line, Line), "Line must be a Line instance"
        assert isinstance(self.time, int), "Time must be an integer"
